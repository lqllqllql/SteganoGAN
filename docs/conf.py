...
version = steganogan.__version__
# The full version, including alpha/beta/rc tags.
release = steganogan.__version__
...
htmlhelp_basename = 'steganogandoc'
...
latex_documents = [
    (master_doc, 'steganogan.tex',
     u'SteganoGAN Documentation',
